...
int s_do_action_actor(zloop_t *loop, int timer, void *arg) {
  ...
  if (arg == 1) {
    ...
    uint8_t *dptr = malloc(sizeof(clock));
    memcpy(dptr, &clock, sizeof(clock));
    int len = sizeof(clock);
    zsock_send(cli1_act, "ssbb", "publish", "testtopic1", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli1_act, "ssbb", "publish", "testtopic2", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli1_act, "ssbb", "publish", "testtopic3", dptr, sizeof(clock),
               &len, sizeof(len));
  }
  if (arg == 2) {
    printf("######################\n");
    ...
    memcpy(dptr, &clock, sizeof(clock));
    int len = sizeof(clock);
    zsock_send(cli2_act, "ssbb", "publish", "testtopic1", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli2_act, "ssbb", "publish", "testtopic2", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli2_act, "ssbb", "publish", "testtopic3", dptr, sizeof(clock),
               &len, sizeof(len));
  }
  if (arg == 3) {
    printf("######################\n");
    ...
    memcpy(dptr, &clock, sizeof(clock));
    int len = sizeof(clock);
    zsock_send(cli3_act, "ssbb", "publish", "testtopic1", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli3_act, "ssbb", "publish", "testtopic2", dptr, sizeof(clock),
               &len, sizeof(len));
    zsock_send(cli3_act, "ssbb", "publish", "testtopic3", dptr, sizeof(clock),
               &len, sizeof(len));
  }
