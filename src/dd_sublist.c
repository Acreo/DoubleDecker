...
dd_sublist_new (void)
{
    dd_sublist_t *self = (dd_sublist_t *) zmalloc (sizeof (dd_sublist_t));
    assert (self);
...
dd_sublist_test (bool verbose)
{
    ...
    dd_sublist_t *self = dd_sublist_new ();
    assert (self);
    dd_sublist_destroy (&self);
    //  @end
    printf ("OK\n");
}
